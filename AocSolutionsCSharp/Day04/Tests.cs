...
namespace AocSolutionsCSharp.Day04
{
    ...
    public class Tests
    {
        ...
        public void Test()
        {
            Assert.That(Solution.Part1(testInput), Is.EqualTo(240));
        }

        [Test]
        public void TestPart2()
        {
            Assert.That(Solution.Part2(testInput), Is.EqualTo(4455));
        }

        [Test]
        public void Part1()
        {
            Assert.That(Solution.Part1(input), Is.EqualTo(94040));
        }

        [Test]
        public void Part2()
        {
            Assert.That(Solution.Part2(input), Is.EqualTo(39940));
        }
        

        private const string testInput = @"[1518-11-01 00:00] Guard #10 begins shift
...
[1518-11-05 00:55] wakes up";
        ...
        private const string input = @"[1518-05-08 00:12] falls asleep
